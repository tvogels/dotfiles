...
sudo scutil --set ComputerName "caslon"
sudo scutil --set HostName "caslon"
sudo scutil --set LocalHostName "caslon"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "caslon"
